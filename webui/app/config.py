...
DEFAULT_SETTINGS = {
    ...
    # Потолок контекста сессии, токенов: от него CLI считает автосжатие. 0 — не
    # задан, сжатие только у края окна модели. 250 тыс. — по разбору
    # rashod-tokenov.md: вдвое дешевле длинных тем при двух-трёх сжатиях на тему.
