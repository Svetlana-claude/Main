...
SVOI = {
    ...
    # зал целиком: участница в подвесной системе, инструктор со шлемом,
    # на столе ноутбук с картинкой из шлема
    "vr-zanyatie.jpg":
